...
<form:form action="./result" method="post" modelAttribute="product">
    ...
    <div class="mb-3">
        ...
        <form:input type="text" class="form-control" id="description" path="description" value="${product.description}" />
    </div>
    <div class="mb-3">
        <label for="categoryId" class="form-label fs-4">Category ID</label>
        <form:input type="text" class="form-control" id="categoryId" path="categoryId" value="${product.categoryId}" />
    </div>
